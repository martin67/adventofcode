...
class Day2BathroomSecurityTest {
    ...
    @ParameterizedTest
    @CsvSource({"1985, out/test/resources/2016/day2-demo1.txt",
            "61529, out/test/resources/2016/day2.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"5DB3, out/test/resources/2016/day2-demo1.txt",
            "C2C28, out/test/resources/2016/day2.txt"})
