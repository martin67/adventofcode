...
class Day7AmplificationCircuitTest {
    ...
    void highestSignal(int expected, String fileName) throws IOException {
    ...
    @CsvSource({"139629729, src/test/resources/2019/day7-demo4.txt",
            ...
            "0, src/test/resources/2019/day7.txt"})
    void highestSignalFeeedbackLoop(int expected, String fileName) throws IOException {
        List<String> inputLines = Files.readAllLines(Paths.get(fileName));
