...
class Day16ProboscideaVolcaniumTest {
    ...
    @ParameterizedTest
    @CsvSource({"1651, src/test/resources/2022/day16-demo1.txt",
            "7763, src/test/resources/2022/day16.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"70, src/test/resources/2022/day16-demo1.txt",
            "2569, src/test/resources/2022/day16.txt"})
