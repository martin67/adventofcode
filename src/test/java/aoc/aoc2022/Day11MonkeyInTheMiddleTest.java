...
class Day11MonkeyInTheMiddleTest {
    ...
    @ParameterizedTest
    @CsvSource({"10605, src/test/resources/2022/day11-demo1.txt",
            "120756, src/test/resources/2022/day11.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"2713310158, src/test/resources/2022/day11-demo1.txt",
            "39109444654, src/test/resources/2022/day11.txt"})
