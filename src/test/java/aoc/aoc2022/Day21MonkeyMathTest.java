...
class Day21MonkeyMathTest {
    ...
    @ParameterizedTest
    @CsvSource({"152, src/test/resources/2022/day21-demo1.txt",
            "80326079210554, src/test/resources/2022/day21.txt"})
    ...
    @ParameterizedTest
    @CsvSource({ //"301, src/test/resources/2022/day21-demo1.txt",
            "3617613952378, src/test/resources/2022/day21.txt"})
