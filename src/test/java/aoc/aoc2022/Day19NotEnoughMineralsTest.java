...
class Day19NotEnoughMineralsTest {
    ...
    @ParameterizedTest
    @CsvSource({"33, src/test/resources/2022/day19-demo1.txt",
            "7763, src/test/resources/2022/day19.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"70, src/test/resources/2022/day19-demo1.txt",
            "2569, src/test/resources/2022/day19.txt"})
