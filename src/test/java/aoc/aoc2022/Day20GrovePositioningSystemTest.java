...
class Day20GrovePositioningSystemTest {
    ...
    @ParameterizedTest
    @CsvSource({"3, src/test/resources/2022/day20-demo1.txt",
            "7395, src/test/resources/2022/day20.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"1623178306, src/test/resources/2022/day20-demo1.txt",
            "1640221678213, src/test/resources/2022/day20.txt"})
