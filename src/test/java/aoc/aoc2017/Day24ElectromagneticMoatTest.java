...
class Day24ElectromagneticMoatTest {
    ...
    @ParameterizedTest
    @CsvSource({"31, src/test/resources/2017/day24-demo1.txt",
            "1940, src/test/resources/2017/day24.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"19, src/test/resources/2017/day24-demo1.txt",
            "1928, src/test/resources/2017/day24.txt"})
