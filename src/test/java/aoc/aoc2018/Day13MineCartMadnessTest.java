...
class Day13MineCartMadnessTest {
    ...
    void ReadFirstData() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("src/test/resources/2018/day13-1.txt"))));
        Day13MineCartMadness day13MineCartMadness = new Day13MineCartMadness(input);
    ...
    void LastCartDemo() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("src/test/resources/2018/day13-2.txt"))));
        Day13MineCartMadness day13MineCartMadness = new Day13MineCartMadness(input);
