...
class Day12SubterraneanSustainabilityTest {
    ...
    void ReadDemoData() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("out/test/resources/day12-1.txt"))));
    ...
    void ReadData() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("out/test/resources/day12-2.txt"))));
