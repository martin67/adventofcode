...
class Day23ExperimentalEmergencyTeleportationTest {
    ...
    @ParameterizedTest
    @CsvSource({"7, out/test/resources/2018/day23-demo0.txt",
            "935, out/test/resources/2018/day23.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"36, out/test/resources/2018/day23-demo1.txt",
            "138697281, out/test/resources/2018/day23.txt"})
