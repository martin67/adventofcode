...
class Day13MineCartMadnessTest {
    ...
    void ReadDemoData() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("out/test/resources/2018/day13-0.txt"))));
    ...
    void ReadFirstData() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("out/test/resources/2018/day13-1.txt"))));
        Day13MineCartMadness day13MineCartMadness = new Day13MineCartMadness(input);
    ...
    void LastCartDemo() throws IOException {
        String input = new String((Files.readAllBytes(Paths.get("out/test/resources/2018/day13-2.txt"))));
        Day13MineCartMadness day13MineCartMadness = new Day13MineCartMadness(input);
