...
class Day24ImmuneSystemSimulator20XXTest {
    ...
    @ParameterizedTest
    @CsvSource({"5216, out/test/resources/2018/day24-demo0.txt",
            "15493, out/test/resources/2018/day24.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"51, out/test/resources/2018/day24-demo0.txt",
            "1045, out/test/resources/2018/day24.txt"})
