...
class Day17PyroclasticFlowTest {
    ...
    @ParameterizedTest
    @CsvSource({"3068, src/test/resources/day17-demo1.txt",
            "3127, src/test/resources/day17.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"1514285714288, src/test/resources/day17-demo1.txt",
            "2569, src/test/resources/day17.txt"})
