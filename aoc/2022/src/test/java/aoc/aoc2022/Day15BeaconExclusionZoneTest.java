...
class Day15BeaconExclusionZoneTest {
    ...
    @ParameterizedTest
    @CsvSource({"25, 9, src/test/resources/day15-demo1.txt",
            "26, 10, src/test/resources/day15-demo1.txt",
            "28, 11, src/test/resources/day15-demo1.txt",
            "5240818, 2000000, src/test/resources/day15.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"56000011, 20, src/test/resources/day15-demo1.txt",
            "13213086906101, 4000000, src/test/resources/day15.txt"})
