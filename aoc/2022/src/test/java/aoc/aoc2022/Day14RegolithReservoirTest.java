...
class Day14RegolithReservoirTest {
    ...
    @ParameterizedTest
    @CsvSource({"24, src/test/resources/day14-demo1.txt",
            "1068, src/test/resources/day14.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"93, src/test/resources/day14-demo1.txt",
            "27936, src/test/resources/day14.txt"})
