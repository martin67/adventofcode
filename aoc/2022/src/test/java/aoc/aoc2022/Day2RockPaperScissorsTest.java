...
class Day2RockPaperScissorsTest {
    ...
    @ParameterizedTest
    @CsvSource({"15, src/test/resources/day2-demo1.txt",
            "11873, src/test/resources/day2.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"12, src/test/resources/day2-demo1.txt",
            "12014, src/test/resources/day2.txt"})
