...
class Day5SupplyStacksTest {
    ...
    @ParameterizedTest
    @CsvSource({"CMZ, src/test/resources/day5-demo1.txt",
            "CNSZFDVLJ, src/test/resources/day5.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"MCD, src/test/resources/day5-demo1.txt",
            "QNDWLMGNS, src/test/resources/day5.txt"})
