...
class Day13DistressSignalTest {
    ...
    @ParameterizedTest
    @CsvSource({"13, src/test/resources/day13-demo1.txt",
            "7763, src/test/resources/day13.txt"})
...
// 5704, 5754, 5804
    ...
    @ParameterizedTest
    @CsvSource({"70, src/test/resources/day13-demo1.txt",
            "2569, src/test/resources/day13.txt"})
