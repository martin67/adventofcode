...
class Day21ScrambledLettersAndHashTest {
    ...
    @ParameterizedTest
    @CsvSource({"decab, abcde, src/test/resources/day21-demo1.txt",
            "dbfgaehc, abcdefgh, src/test/resources/day21.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"abcdefgh, dbfgaehc, src/test/resources/day21.txt",
            "aghfcdeb, fbgdceah, src/test/resources/day21.txt"})
