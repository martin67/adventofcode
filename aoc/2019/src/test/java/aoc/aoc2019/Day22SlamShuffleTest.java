...
class Day22SlamShuffleTest {
    ...
    @ParameterizedTest
    @CsvSource({"0, 10, src/test/resources/day22-demo1.txt",
            "0, 10, src/test/resources/day22-demo2.txt",
            "0, 10, src/test/resources/day22-demo3.txt",
            "0, 10, src/test/resources/day22-demo4.txt",
            "4086, 10007, src/test/resources/day22.txt"})
    ...
    void problem2() throws IOException {
        List<String> inputLines = Files.readAllLines(Paths.get("src/test/resources/day22.txt"));
