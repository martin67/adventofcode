...
class Day6UniversalOrbitMapTest {
    ...
    @ParameterizedTest
    @CsvSource({"42, src/test/resources/day6-demo1.txt",
            "119831, src/test/resources/day6.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"4, src/test/resources/day6-demo2.txt",
            "322, src/test/resources/day6.txt"})
