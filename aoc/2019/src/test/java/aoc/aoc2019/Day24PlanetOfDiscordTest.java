...
class Day24PlanetOfDiscordTest {
    ...
    @ParameterizedTest
    @CsvSource({"2129920, src/test/resources/day24-demo1.txt",
            "28778811, src/test/resources/day24.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"99, 10, src/test/resources/day24-demo1.txt",
            "2097, 200, src/test/resources/day24.txt"})
