...
class Day12TheNBodyProblemTest {
    ...
    @ParameterizedTest
    @CsvSource({"179, 10, src/test/resources/day12-demo1.txt",
            "1940, 100, src/test/resources/day12-demo2.txt",
            "6490, 1000, src/test/resources/day12.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"2772, src/test/resources/day12-demo1.txt",
            "277068010964808, src/test/resources/day12.txt"})
