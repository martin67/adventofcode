...
class Day10SyntaxScoringTest {
    ...
    @ParameterizedTest
    @CsvSource({"26397, src/test/resources/day10-demo1.txt",
            "367227, src/test/resources/day10.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"288957, src/test/resources/day10-demo1.txt",
            "3583341858, src/test/resources/day10.txt"})
