...
class Day20TrenchMapTest {
    ...
    @ParameterizedTest
    @CsvSource({"35, src/test/resources/day20-demo1.txt",
            "5097, src/test/resources/day20.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"3351, src/test/resources/day20-demo1.txt",
            "0, src/test/resources/day20.txt"})
