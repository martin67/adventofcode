...
class Day7TheTreacheryOfWhalesTest {
    ...
    @ParameterizedTest
    @CsvSource({"37, src/test/resources/day7-demo1.txt",
            "352254, src/test/resources/day7.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"168, src/test/resources/day7-demo1.txt",
            "99053143, src/test/resources/day7.txt"})
