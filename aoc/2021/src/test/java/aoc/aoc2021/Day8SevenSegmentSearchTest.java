...
class Day8SevenSegmentSearchTest {
    ...
    @ParameterizedTest
    @CsvSource({"0, src/test/resources/day8-demo1.txt",
            "26, src/test/resources/day8-demo2.txt",
            "548, src/test/resources/day8.txt"})
    void problem1(int expected, String fileName) throws IOException {
        assertEquals(expected, new Day8SevenSegmentSearch(Files.readAllLines(Paths.get(fileName))).problem1());
    }

    @ParameterizedTest
    @CsvSource({"5353, src/test/resources/day8-demo1.txt",
            "61229, src/test/resources/day8-demo2.txt",
            "1074888, src/test/resources/day8.txt"})
