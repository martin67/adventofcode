...
class Day6LanternfishTest {
    ...
    @ParameterizedTest
    @CsvSource({"5934, src/test/resources/day6-demo1.txt",
            "387413, src/test/resources/day6.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"26984457539, src/test/resources/day6-demo1.txt",
            "1738377086345, src/test/resources/day6.txt"})
