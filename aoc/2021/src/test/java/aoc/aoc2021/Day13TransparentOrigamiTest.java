...
class Day13TransparentOrigamiTest {
    ...
    @ParameterizedTest
    @CsvSource({"17, src/test/resources/day13-demo1.txt",
            "775, src/test/resources/day13.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"0, src/test/resources/day13-demo1.txt",
            "0, src/test/resources/day13.txt"})
