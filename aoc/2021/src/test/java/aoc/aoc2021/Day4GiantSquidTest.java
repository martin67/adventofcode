...
class Day4GiantSquidTest {
    ...
    @ParameterizedTest
    @CsvSource({"4512, src/test/resources/day4-demo1.txt",
            "8136, src/test/resources/day4.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"1924, src/test/resources/day4-demo1.txt",
            "12738, src/test/resources/day4.txt"})
