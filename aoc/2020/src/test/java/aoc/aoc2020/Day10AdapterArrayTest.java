...
class Day10AdapterArrayTest {
    ...
    @ParameterizedTest
    @CsvSource({"35, src/test/resources/day10-demo1.txt",
            "220, src/test/resources/day10-demo2.txt",
            "2210, src/test/resources/day10.txt"})
    ...
    @CsvSource({"8, src/test/resources/day10-demo1.txt",
            "19208, src/test/resources/day10-demo2.txt",
            "7086739046912, src/test/resources/day10.txt"})
