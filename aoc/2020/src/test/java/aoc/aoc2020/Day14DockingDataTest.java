...
class Day14DockingDataTest {
    ...
    @ParameterizedTest
    @CsvSource({"165, src/test/resources/day14-demo1.txt",
            "12610010960049, src/test/resources/day14.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"208, src/test/resources/day14-demo2.txt",
            "3608464522781, src/test/resources/day14.txt"})
