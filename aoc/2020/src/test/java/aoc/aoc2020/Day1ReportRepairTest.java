...
class Day1ReportRepairTest {
    ...
    @ParameterizedTest
    @CsvSource({"514579, src/test/resources/day1-demo1.txt",
            "712075, src/test/resources/day1.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"241861950, src/test/resources/day1-demo1.txt",
            "145245270, src/test/resources/day1.txt"})
