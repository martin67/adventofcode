...
class Day24LobbyLayoutTest {
    ...
    @ParameterizedTest
    @CsvSource({"10, src/test/resources/day24-demo1.txt",
            "400, src/test/resources/day24.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"2208, src/test/resources/day24-demo1.txt",
            "3768, src/test/resources/day24.txt"})
