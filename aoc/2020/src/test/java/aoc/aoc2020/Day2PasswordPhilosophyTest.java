...
class Day2PasswordPhilosophyTest {
    ...
    @ParameterizedTest
    @CsvSource({"2, src/test/resources/day2-demo1.txt",
            "603, src/test/resources/day2.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"1, src/test/resources/day2-demo1.txt",
            "404, src/test/resources/day2.txt"})
