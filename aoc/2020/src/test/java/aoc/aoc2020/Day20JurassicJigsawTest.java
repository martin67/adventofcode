...
class Day20JurassicJigsawTest {
    ...
    @ParameterizedTest
    @CsvSource({"20899048083289, src/test/resources/day20-demo1.txt",
            "21599955909991, src/test/resources/day20.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"273, src/test/resources/day20-demo1.txt",
            "2495, src/test/resources/day20.txt"})
