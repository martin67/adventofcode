...
class Day3TobogganTrajectoryTest {
    ...
    @ParameterizedTest
    @CsvSource({"7, src/test/resources/day3-demo1.txt",
            "176, src/test/resources/day3.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"336, src/test/resources/day3-demo1.txt",
            "5872458240, src/test/resources/day3.txt"})
