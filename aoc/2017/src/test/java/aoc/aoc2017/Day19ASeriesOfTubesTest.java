...
class Day19ASeriesOfTubesTest {
    ...
    @ParameterizedTest
    @CsvSource({"ABCDEF, src/test/resources/day19-demo1.txt",
            "VEBTPXCHLI, src/test/resources/day19.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"38, src/test/resources/day19-demo1.txt",
            "18702, src/test/resources/day19.txt"})
