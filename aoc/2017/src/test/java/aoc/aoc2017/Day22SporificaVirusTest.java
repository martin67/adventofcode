...
class Day22SporificaVirusTest {
    ...
    @ParameterizedTest
    @CsvSource({"5, 7, src/test/resources/day22-demo1.txt",
            "41, 70, src/test/resources/day22-demo1.txt",
            "5587, 10000, src/test/resources/day22-demo1.txt",
            "5348, 10000, src/test/resources/day22.txt"})
    ...
    @ParameterizedTest
    @CsvSource({"26, 100, src/test/resources/day22-demo1.txt",
            "2511944, 10000000, src/test/resources/day22-demo1.txt",
            "2512225, 10000000, src/test/resources/day22.txt"})
