...
class Day6MemoryReallocationTest {
    ...
    @ParameterizedTest
    @CsvSource({"5, src/test/resources/day6-demo1.txt",
            "5042, src/test/resources/day6.txt"})
    void problem1(int expected, String fileName) throws IOException {
        assertEquals(expected, new Day6MemoryReallocation(Files.readAllLines(Paths.get(fileName))).countCycles(false));
    }

    @ParameterizedTest
    @CsvSource({"4, src/test/resources/day6-demo1.txt",
            "1086, src/test/resources/day6.txt"})
