...
class Day13PacketScannersTest {
    ...
    @ParameterizedTest
    @CsvSource({"24, src/test/resources/day13-demo1.txt",
            "1928, src/test/resources/day13.txt"})
    void problem1(int expected, String fileName) throws IOException {
        assertEquals(expected, new Day13PacketScanners(Files.readAllLines(Paths.get(fileName))).tripSeverity());
    }

    @ParameterizedTest
    @CsvSource({"10, src/test/resources/day13-demo1.txt",
            "3830344, src/test/resources/day13.txt"})
